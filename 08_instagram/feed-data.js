...
window.RELICTUM_FEED = [
  ...
  },
  {
    ...
    caption: { lead: 'Череп мамонта, Якутия', body: 'Череп с обоими бивнями на месте встречается заметно реже, чем отдельные бивни. Размах — 2,4 метра, карамельная патина вечной мерзлоты, происхождение прослежено и подкреплено экспертизами.', cta: 'Паспорт объекта и стоимость — по запросу в галерею.' },
