...
(function(){
  ...
  var Shop={
    ...
    addToCart:function(id){ var c=read(CART_KEY); if(c.indexOf(id)<0){c.push(id);write(CART_KEY,c);} try{if(window.ym&&window.RELICTUM_YM)ym(window.RELICTUM_YM,'reachGoal','cart_add');}catch(e){} },
    ...
    send:function(kind,rec){
      try{if(window.ym&&window.RELICTUM_YM)ym(window.RELICTUM_YM,'reachGoal',/^заказ/i.test(kind)?'order':'lead');}catch(e){}
      try{
